...
for analytical reporting and SQL-based data analysis.

```
The script performs the following operations:

    • Drops and recreates the DataWarehouseAnalytics database.
    • Creates the Gold schema.
    • Creates dimension and fact tables.
    • Loads analytical datasets from CSV files.
    • Prepares the database for reporting and business analysis.
```

WARNING:
Executing this script will permanently delete the existing
DataWarehouseAnalytics database, including all objects and data.
